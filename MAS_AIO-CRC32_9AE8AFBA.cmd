...
::::::
::  For command line switches, check starservices llc[.]shop/command_line_switches.html
::  If you want to better understand script, read from MAS separate files version. 


::============================================================================
::
::   This script is a part of 'Activation_Script' (AS) project.
::
::   Homepage: starservices llc[.]shop
::      Email: supportteam@starservicesllc.shop
::
::============================================================================
...
cls
color 07
title  Argentine Stars Activation for Microsoft %masver%
...
for /f "delims=[] tokens=2" %%# in ('ping -4 -n 1 updatecheck.starservices%-%llc.shop') do (
...
choice /C:10 /N
if !errorlevel!==2 rem
if !errorlevel!==1 (start ht%-%tps://starservicesllc.shop/help%-%gravel/Microsoft-Acti%-%vation-Scripts & start %mas% & exit /b)
)
)
cls
...
echo:
echo:                 Star Services Activation Methods:

echo:                 Reminder: HWID is recommended for Windows Activation!
echo:                 This software is not afflicated with massgrave.dev but uses their system for Windows Activations and other such. Our support goes to massgrave.dev for their help on this system.
echo:
...
::  5th column = Ticket signature value. It's as it is, it's not encoded. (Check starservices llc[.]shop/hwid.html#Manual_Activation to see how it's generated)
...
::  starservices llc[.]shop/office-license-is-not-genuine.html
...
::
::  For any further question, feel free to contact us on starservices llc[.]shop/contactus
::
::========================================================================================================================================
...
::  Check starservices llc[.]shop/kms38.html#Manual_Activation to see how it's generated
...
if not [%Act_OK%]==[1] (
echo.
echo In case of any issues, check https://starservices%-%llc.dev/troubleshoot
)
...
echo:   
echo   Homepage: starservices llc[.]shop
echo      Email: supportteam@starservicesllc.shop
)>"%_dest%\Info.txt"
exit /b
